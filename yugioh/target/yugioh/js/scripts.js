function obtenerCarta(){
    ...
    api.onreadystatechange=function(){
        if(this.status==200 && this.readyState==4){
            ...
            var imgcartayus=respuesta['data'][10759]["card_images"][0]["image_url_small"]
            var imgcartayuma=respuesta['data'][8062]['card_images'][0]['image_url_small']
            var imgcartayuya=respuesta['data'][8221]['card_images'][0]['image_url_small']
